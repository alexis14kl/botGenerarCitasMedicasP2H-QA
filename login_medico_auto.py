...
def run_node_full_flow() -> int:
    ...
    env.setdefault("MODULE_LOAD_POLL_TIMEOUT_MS", os.getenv("MODULE_LOAD_POLL_TIMEOUT_MS", "45000"))
    ...
    env.setdefault("NOTA_MEDICA_CLICK_TIMEOUT_MS", os.getenv("NOTA_MEDICA_CLICK_TIMEOUT_MS", "12000"))
...
def main() -> int:
    ...
    log(
        ...
        f' MODULE_LOAD_POLL_TIMEOUT_MS={os.getenv("MODULE_LOAD_POLL_TIMEOUT_MS", "45000")}'
